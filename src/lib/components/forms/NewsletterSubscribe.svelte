...
<div id="mc_embed_signup">
    ...
    <div aria-hidden="true" style="position: absolute; left: -5000px;">
        ...
        <input type="text" name="b_4ab15f53049e8198529e0fff2_02f6134a15" tabindex="-1" value="">
    </div>
...
<script type="text/javascript" src="//s3.amazonaws.com/downloads.mailchimp.com/js/mc-validate.js"></script><script type="text/javascript">(function($) {window.fnames = new Array(); window.ftypes = new Array();fnames[0]='EMAIL';ftypes[0]='email';fnames[1]='FNAME';ftypes[1]='text';fnames[2]='LNAME';ftypes[2]='text';fnames[7]='MMERGE7';ftypes[7]='text';fnames[8]='MMERGE8';ftypes[8]='text';}(jQuery));var $mcj = jQuery.noConflict(true);
    ...
    function initializeSmsPhoneDropdown(fieldName) {
      ...
      var smsField = Object.values({"EMAIL":{"name":"EMAIL","label":"email address","helper_text":"","merge_id":0,"type":"email","required":true,"audience_field_name":"email address","field_type":"merge","enabled":true,"order":0},"FNAME":{"name":"FNAME","label":"first name","helper_text":"","type":"text","required":false,"audience_field_name":"first name","enabled":true,"order":1,"field_type":"merge","merge_id":1},"LNAME":{"name":"LNAME","label":"last name","helper_text":"","type":"text","required":false,"audience_field_name":"last name","enabled":true,"order":2,"field_type":"merge","merge_id":2},"MMERGE7":{"name":"MMERGE7","label":"state or territory","helper_text":"","type":"text","required":false,"audience_field_name":"state or territory","enabled":true,"order":3,"field_type":"merge","merge_id":7},"MMERGE8":{"name":"MMERGE8","label":"organization","helper_text":"","type":"text","required":false,"audience_field_name":"organization","enabled":false,"order":null,"field_type":"merge","merge_id":8}}).find(function(f) { return f.name === fieldName && f.type === 'smsphone'; });
