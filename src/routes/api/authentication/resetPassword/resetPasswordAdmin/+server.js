...
export async function POST({request}) {
    ...
    if (administrator.length === 0) {
        ...
        return new Response(JSON.stringify({error: `no administrator with ${email} as email exists!`}), {status: 422});
    ...
    // add the token and token expiration date to the user row in administrators table
    ...
    const msg = {
        ...
        html: `
            ...
            <p>Click <a href="${DOMAIN}/update-password/administrator/${token}" >this link to set a new password.</a></p>
            <p>Kind regards,</p>
