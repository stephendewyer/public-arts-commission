<script lang="ts">
    ...
    const endorsedCandidateWithImage = data.streamed.endorsedCandidateWithImage;

    let imageFileInputValue: string = "";
    let candidateID: number = endorsedCandidateWithImage.candidate_ID;
    let imageID: number | null = endorsedCandidateWithImage.image_ID ? endorsedCandidateWithImage.image_ID : null;
    let imageAltTextInputValue: string = endorsedCandidateWithImage.alt_text ? endorsedCandidateWithImage.alt_text : "";
    let image: any = endorsedCandidateWithImage.image_URL ? endorsedCandidateWithImage.image_URL : null;
    let imagePublicID: string = endorsedCandidateWithImage.public_ID ? endorsedCandidateWithImage.public_ID : "";
    let campaignNameInputValue: string = endorsedCandidateWithImage.campaign_name ? endorsedCandidateWithImage.campaign_name : "";
    let electorateInputValue: string = endorsedCandidateWithImage.electorate ? endorsedCandidateWithImage.electorate : "";
    let yearOfficeSoughtInputValue: number | string = endorsedCandidateWithImage.office_sought_starting_year ? endorsedCandidateWithImage.office_sought_starting_year : "";
    let electionDatePrimaryInputValue: string = ConvertDateInputFormat(new Date(endorsedCandidateWithImage.election_date_primary)) ? ConvertDateInputFormat(new Date(endorsedCandidateWithImage.election_date_primary)) : "";
    let electionDateGeneralInputValue: string = ConvertDateInputFormat(new Date(endorsedCandidateWithImage.election_date_general)) ? ConvertDateInputFormat(new Date(endorsedCandidateWithImage.election_date_general)) : "";
    let governmentLevelInputValue: string = endorsedCandidateWithImage.government_level ? endorsedCandidateWithImage.government_level : "";
    let stateInputValue: string = endorsedCandidateWithImage.state ? endorsedCandidateWithImage.state : "";
    let countyInputValue: string = endorsedCandidateWithImage.county ? endorsedCandidateWithImage.county : "";
    let cityInputValue: string = endorsedCandidateWithImage.city ? endorsedCandidateWithImage.city : "";
    let partyInputValue: string = endorsedCandidateWithImage.party ? endorsedCandidateWithImage.party : "";
    let websiteURLInputValue: string = endorsedCandidateWithImage.website_URL ? endorsedCandidateWithImage.website_URL : "";
    let runningInPrimaryChecked: boolean | any = endorsedCandidateWithImage.running_in_primary;
    let electedInPrimaryChecked: boolean | any = endorsedCandidateWithImage.elected_in_primary;
    let rejectedInPrimaryChecked: boolean | any = endorsedCandidateWithImage.rejected_in_primary;
    let runnningInGeneralChecked: boolean | any = endorsedCandidateWithImage.running_in_general;
    let electedInGeneralChecked: boolean | any = endorsedCandidateWithImage.elected_in_general;
    let rejectedInGeneralChecked: boolean | any = endorsedCandidateWithImage.rejected_in_general;
    let campaignEndedChecked: boolean | any = endorsedCandidateWithImage.campaign_ended;
    let nameFirstContactInputValue: string = endorsedCandidateWithImage.contact_name_first ? endorsedCandidateWithImage.contact_name_first : "";
    let nameLastContactInputValue: string = endorsedCandidateWithImage.contact_name_last ? endorsedCandidateWithImage.contact_name_last : "";
    let phoneContactInputValue: E164Number | string = endorsedCandidateWithImage.contact_phone_number ? endorsedCandidateWithImage.contact_phone_number : "";
    let streetAddressContactInputValue: string = endorsedCandidateWithImage.contact_street_address ? endorsedCandidateWithImage.contact_street_address : "";
    let streetAddress02ContactInputValue: string = endorsedCandidateWithImage.contact_street_address_02 ? endorsedCandidateWithImage.contact_street_address_02 : "";
    let cityContactInputValue: string = endorsedCandidateWithImage.contact_city ? endorsedCandidateWithImage.contact_city : "";
    let stateContactInputValue: string = endorsedCandidateWithImage.contact_state ? endorsedCandidateWithImage.contact_state : "";
    let zipCodeContactInputValue: number | string = endorsedCandidateWithImage.contact_zip_code ? endorsedCandidateWithImage.contact_zip_code : "";
    let emailContactInputValue: string = endorsedCandidateWithImage.contact_email ? endorsedCandidateWithImage.contact_email : "";
