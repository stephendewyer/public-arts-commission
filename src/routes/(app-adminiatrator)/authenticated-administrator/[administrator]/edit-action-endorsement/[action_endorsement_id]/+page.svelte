<script lang="ts">
    ...
    const endorsedAction: ActionWithImage = data.streamed.endorsedActionWithImage; 

    let actionID: number | null = endorsedAction.action_ID ? endorsedAction.action_ID : null;
    let imageID: number | null = endorsedAction.image_ID ? endorsedAction.image_ID : null;
    let imageFileInputValue: string = "";
    let imagePublicID: string = endorsedAction.public_ID ? endorsedAction.public_ID : "";
    let imageAltTextInputValue: string = endorsedAction.alt_text ? reverseHtmlEntities(endorsedAction.alt_text) : "";
    let image: string = endorsedAction.image_URL ? endorsedAction.image_URL : "";
    let actionNameInputValue: string = endorsedAction.action_name ? endorsedAction.action_name : "";
    let allDayActionChecked: boolean = endorsedAction.all_day_event;
    let allDayActionDateInputValue: string = endorsedAction.all_day_event_date ? ConvertDateInputFormat(endorsedAction.all_day_event_date): "";
    let actionStartDateInputValue: string = endorsedAction.date_start ? ConvertDateInputFormat(endorsedAction.date_start) : "";
    let actionEndDateInputValue: string = endorsedAction.date_end ? ConvertDateInputFormat(endorsedAction.date_end) : "";
    let startTimeInputValue: string = endorsedAction.time_start ? endorsedAction.time_start.toString() : "";
    let endTimeInputValue: string = endorsedAction.time_end ? endorsedAction.time_end.toString() : "";
    let timeZoneInputValue: string = endorsedAction.time_zone ? endorsedAction.time_zone : "";
    let actionStreetAddressInputValue: string = endorsedAction.action_street_address ? endorsedAction.action_street_address : "";
    let actionStreetAddress02InputValue: string = endorsedAction.action_street_address_02 ? endorsedAction.action_street_address_02 : "";
    let actionCityInputValue: string = endorsedAction.action_city ? endorsedAction.action_city : "";
    let actionStateInputValue: string = endorsedAction.action_state ? endorsedAction.action_state : "";
    let actionZipCodeInputValue: number | string = endorsedAction.action_zip_code ? endorsedAction.action_zip_code : "";
    let governmentLevelInputValue: string = endorsedAction.government_level ? endorsedAction.government_level : "";
    let websiteURLInputValue: string = endorsedAction.website_URL ? endorsedAction.website_URL : "";
    let detailsInputValue: string = endorsedAction.details ? endorsedAction.details : "";

    let nameFirstContactInputValue: string = endorsedAction.contact_name_first ? endorsedAction.contact_name_first : "";
    let nameLastContactInputValue: string = endorsedAction.contact_name_last ? endorsedAction.contact_name_last : "";
    let phoneContactInputValue: E164Number | string = endorsedAction.contact_phone_number ? endorsedAction.contact_phone_number : "";
    let streetAddressContactInputValue: string = endorsedAction.contact_street_address ? endorsedAction.contact_street_address : "";
    let streetAddress02ContactInputValue: string = endorsedAction.contact_street_address_02 ? endorsedAction.contact_street_address_02 : "";
    let cityContactInputValue: string = endorsedAction.contact_city ? endorsedAction.contact_city : "";
    let stateContactInputValue: string = endorsedAction.contact_state ? endorsedAction.contact_state : "";
    let zipCodeContactInputValue: number | string = endorsedAction.contact_zip_code ? endorsedAction.contact_zip_code : "";
    let emailContactInputValue: string = endorsedAction.contact_email ? endorsedAction.contact_email : "";
