<script lang="ts">
    ...
    const endorsedLegislationImagesAndSponsors = data.streamed.endorsedLegislationImagesAndSponsors;
    
    let addHouseCoSponsor: boolean = false;
    let addSenateCoSponsor: boolean = false;

    let legislationID: number | null = endorsedLegislationImagesAndSponsors.legislation_ID ? endorsedLegislationImagesAndSponsors.legislation_ID : null;

    let coSponsorsHouseValues: CoSponsorInputValue[] = [];

    if (endorsedLegislationImagesAndSponsors.co_sponsors_House.length > 0) {
        endorsedLegislationImagesAndSponsors.co_sponsors_House.forEach((sponsor: CoSponsorHouse) => {
    ...
    if (endorsedLegislationImagesAndSponsors.co_sponsors_Senate.length > 0) {
        endorsedLegislationImagesAndSponsors.co_sponsors_Senate.forEach((sponsor: CoSponsorSenate) => {
    ...
    let imageAltTextInputValue: string = endorsedLegislationImagesAndSponsors.alt_text ? reverseHtmlEntities(endorsedLegislationImagesAndSponsors.alt_text) : "";
    let image: string | any = endorsedLegislationImagesAndSponsors.image_URL ? endorsedLegislationImagesAndSponsors.image_URL : "";
    let imageID: number | null = endorsedLegislationImagesAndSponsors.image_ID ? endorsedLegislationImagesAndSponsors.image_ID : null;
    let imagePublicID: string = endorsedLegislationImagesAndSponsors.public_ID ? endorsedLegislationImagesAndSponsors.public_ID : "";
    let legislationTitleInputValue: string = endorsedLegislationImagesAndSponsors.legislation_name ? reverseHtmlEntities(endorsedLegislationImagesAndSponsors.legislation_name) : "";
    let yearReleasedInputValue: number | string = endorsedLegislationImagesAndSponsors.year_released ? endorsedLegislationImagesAndSponsors.year_released : "";
    let yearIntroducedInHouseInputValue: number | string = endorsedLegislationImagesAndSponsors.year_introduced_House ? endorsedLegislationImagesAndSponsors.year_introduced_House : "";
    let yearIntroducedInSenateInputValue: number | string = endorsedLegislationImagesAndSponsors.year_introduced_Senate ? endorsedLegislationImagesAndSponsors.year_introduced_Senate : "";
    let governmentLevelInputValue: string = endorsedLegislationImagesAndSponsors.government_level ? endorsedLegislationImagesAndSponsors.government_level : "";
    let stateInputValue: string = endorsedLegislationImagesAndSponsors.state ? endorsedLegislationImagesAndSponsors.state : "";
    let countyInputValue: string = endorsedLegislationImagesAndSponsors.county ? endorsedLegislationImagesAndSponsors.county : "";
    let cityInputValue: string = endorsedLegislationImagesAndSponsors.city ? endorsedLegislationImagesAndSponsors.city : "";
    let websiteURLInputValue: string = endorsedLegislationImagesAndSponsors.website_URL ? endorsedLegislationImagesAndSponsors.website_URL : "";
    let detailsInputValue: string = endorsedLegislationImagesAndSponsors.details ? reverseHtmlEntities(endorsedLegislationImagesAndSponsors.details) : "";
    let introducedInHouseChecked: boolean = endorsedLegislationImagesAndSponsors.year_introduced_House ? true : false;
    let introducedInSenateChecked: boolean = endorsedLegislationImagesAndSponsors.year_introduced_Senate ? true : false;
    let sponsorHouseInputValue: string = endorsedLegislationImagesAndSponsors.sponsors_House[0]?.sponsor_name ? endorsedLegislationImagesAndSponsors.sponsors_House[0]?.sponsor_name : "";
    let sponsorSenateInputValue: string = endorsedLegislationImagesAndSponsors.sponsors_Senate[0]?.sponsor_name ? endorsedLegislationImagesAndSponsors.sponsors_Senate[0]?.sponsor_name : "";
    let houseSessionInputValue: string = endorsedLegislationImagesAndSponsors.session_House ? endorsedLegislationImagesAndSponsors.session_House : "";
    let senateSessionInputValue: string = endorsedLegislationImagesAndSponsors.session_Senate ? endorsedLegislationImagesAndSponsors.session_Senate : "";
    let passedInHouseChecked: boolean | any = endorsedLegislationImagesAndSponsors.passed_in_House;
    let passedInSenateChecked: boolean | any = endorsedLegislationImagesAndSponsors.passed_in_Senate;
    let rejectedByHouseChecked: boolean | any = endorsedLegislationImagesAndSponsors.rejected_in_House;
    let rejectedBySenateChecked: boolean | any = endorsedLegislationImagesAndSponsors.rejected_in_Senate;
    let vetoedByExecutiveChecked: boolean | any = endorsedLegislationImagesAndSponsors.vetoed_by_Executive;
    let ExecutiveSignedIntoLawChecked: boolean | any = endorsedLegislationImagesAndSponsors.signed_by_Executive;
    
    let nameFirstContactInputValue: string = endorsedLegislationImagesAndSponsors.contact_name_first ? endorsedLegislationImagesAndSponsors.contact_name_first : "";
    let nameLastContactInputValue: string = endorsedLegislationImagesAndSponsors.contact_name_last ? endorsedLegislationImagesAndSponsors.contact_name_last : "";
    let phoneContactInputValue: E164Number | string = endorsedLegislationImagesAndSponsors.contact_phone_number ? endorsedLegislationImagesAndSponsors.contact_phone_number : "";
    let streetAddressContactInputValue: string = endorsedLegislationImagesAndSponsors.contact_street_address ? endorsedLegislationImagesAndSponsors.contact_street_address : "";
    let streetAddress02ContactInputValue: string = endorsedLegislationImagesAndSponsors.contact_street_address_02 ? endorsedLegislationImagesAndSponsors.contact_street_address_02 : "";
    let cityContactInputValue: string = endorsedLegislationImagesAndSponsors.contact_city ? endorsedLegislationImagesAndSponsors.contact_city : "";
    let stateContactInputValue: string = endorsedLegislationImagesAndSponsors.contact_state ? endorsedLegislationImagesAndSponsors.contact_state : "";
    let zipCodeContactInputValue: number | string = endorsedLegislationImagesAndSponsors.contact_zip_code ? endorsedLegislationImagesAndSponsors.contact_zip_code : "";
    let emailContactInputValue: string = endorsedLegislationImagesAndSponsors.contact_email ? endorsedLegislationImagesAndSponsors.contact_email : "";
    let noContactInformationChecked: boolean = false;
...
<div class="add_legislation_endorsement_container">
    <h1>edit legislation endorsement</h1>
    <form 
