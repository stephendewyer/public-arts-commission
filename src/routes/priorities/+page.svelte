...
<section>
    ...
    <div class="priorities_for_government_container">
    ...
    <div class="priorities_for_climate_container">
        <ol class="category_priorities">
            <li class="priority_heading">
                <PriorityAccordion>
                    <span slot="head">
    ...
    <div class="priorities_for_economy_container">
        <ol class="category_priorities">
            <li class="priority_heading">
                <PriorityAccordion>
                    <span slot="head">
    ...
    <div class="priorities_for_education_container">
        <ol class="category_priorities">
            <li class="priority_heading">
                <PriorityAccordion>
                    <span slot="head">
    ...
    <div class="priorities_for_health_container">
        <ol class="category_priorities">
            <li class="priority_heading">
                Medicare for all
            </li>
