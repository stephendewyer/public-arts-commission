<script lang="ts">
    ...
    let userCampaignInformation: CampaignUserInformation | any = null;

    let campaignUserInformationID: number;
    
    if (data.campaignUserInformationRow) {

        userCampaignInformation = data.campaignUserInformationRow;
    };

    $: campaignUserInformationID = userCampaignInformation.campaign_user_information_ID;

    let campaignUserID: number;

    $: campaignUserID = userCampaignInformation.user_ID;

    let userEmail: string | null | undefined | any;
    ...
    let phoneNumberInputValue: E164Number | null = userCampaignInformation.phone_number.toString()
